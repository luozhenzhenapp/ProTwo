...
<h2 style="text-align: center; color: white; font-family: '华文行楷'; font-size: 500%">生物机电图书管理系统</h2>
...
<div class="panel panel-default" id="login">
    ...
    <div class="panel-body">
        ...
        <button id="registerButton"  class="btn btn-primary  btn-block" onclick="window.location.href='register.jsp'">注册
        </button>
    </div>
</div>
    <script>
